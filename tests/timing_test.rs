...
fn test_hint_short_word() {
    let hint = generate_timing_hint("the", false, false, false, false);
...
fn test_hint_long_word() {
    ...
    let hint = generate_timing_hint("beautiful", false, false, false, false);
...
fn test_hint_very_long_word() {
    ...
    // total = 80 + 120 = 200
    let hint = generate_timing_hint("extraordinary", false, false, false, false);
    assert_eq!(hint.word_length_modifier, 200);
}

#[test]
fn test_hint_comma() {
    let hint = generate_timing_hint("word,", false, false, false, false);
    assert_eq!(hint.punctuation_modifier, 150);
}

#[test]
fn test_hint_period() {
    let hint = generate_timing_hint("end.", false, false, false, false);
    assert_eq!(hint.punctuation_modifier, 200);
}

#[test]
fn test_hint_question() {
    let hint = generate_timing_hint("why?", false, false, false, false);
    assert_eq!(hint.punctuation_modifier, 200);
}

#[test]
fn test_hint_paragraph_break() {
    let hint = generate_timing_hint("word", true, false, false, false);
    assert_eq!(hint.structure_modifier, 300);
}

#[test]
fn test_hint_new_block() {
    let hint = generate_timing_hint("word", false, true, false, false);
    assert_eq!(hint.structure_modifier, 150);
}

#[test]
fn test_hint_last_table_cell() {
    let hint = generate_timing_hint("word", false, false, true, false);
